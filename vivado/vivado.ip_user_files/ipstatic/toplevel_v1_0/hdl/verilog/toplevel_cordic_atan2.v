...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_1) & (1'b1 == ap_reg_ppiten_pp0_it0) & (1'b0 == exitcond_fu_347_p2))) begin
        p_4_reg_128 <= i_V_fu_353_p2;
    end else if (((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~(ap_start == 1'b0) & (tmp_167_fu_201_p2 == 1'b0) & (tmp_168_fu_207_p2 == 1'b0))) begin
        p_4_reg_128 <= ap_const_lv4_0;
    end
end
...
assign exitcond_fu_347_p2 = ((p_4_reg_128 == ap_const_lv4_9) ? 1'b1 : 1'b0);

assign i_V_fu_353_p2 = (p_4_reg_128 + ap_const_lv4_1);
...
assign quadrant_3_fu_323_p3 = ((tmp_101_fu_317_p2[0:0] === 1'b1) ? sel_tmp4_cast_fu_309_p3 : sel_tmp_fu_271_p3);
...
assign sel_tmp8_fu_303_p2 = (tmp_173_fu_243_p3 & sel_tmp7_fu_297_p2);

assign sel_tmp_fu_271_p3 = ((tmp_100_fu_265_p2[0:0] === 1'b1) ? p_s_fu_257_p3 : ap_const_lv3_0);

assign sh_cast_fu_365_p1 = p_4_reg_128;

assign storemerge1_cast_cast_fu_339_p3 = ((tmp_fu_157_p3[0:0] === 1'b1) ? ap_const_lv16_3243 : ap_const_lv16_0);

assign storemerge_cast_cast_fu_331_p3 = ((tmp_166_fu_179_p3[0:0] === 1'b1) ? ap_const_lv16_E6DF : ap_const_lv16_1921);

assign tmp_100_fu_265_p2 = (tmp_s_fu_225_p2 | tmp_174_fu_251_p2);

assign tmp_101_fu_317_p2 = (sel_tmp8_fu_303_p2 | sel_tmp3_fu_285_p2);

assign tmp_166_fu_179_p3 = y0_V[ap_const_lv32_11];
...
assign tmp_173_fu_243_p3 = tmp_172_fu_237_p2[ap_const_lv32_11];

assign tmp_174_fu_251_p2 = (tmp_169_fu_213_p2 & tmp_166_fu_179_p3);

assign tmp_175_fu_455_p2 = ((quadrant_3_reg_525 == ap_const_lv3_1) ? 1'b1 : 1'b0);

assign tmp_176_fu_393_p1 = p_4_reg_128;
...
assign y_V_1_fu_193_p3 = ((tmp_166_fu_179_p3[0:0] === 1'b1) ? y_V_fu_187_p2 : y0_V);
