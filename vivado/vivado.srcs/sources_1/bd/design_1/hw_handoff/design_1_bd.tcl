...
CONFIG.NUM_MI {1} \
  ...
  set_property -dict [ list \
CONFIG.C_M_AXI_OCM_TARGET_ADDR {0xFFFC0000} \
 ] $toplevel_0
...
CONFIG.CONST_WIDTH {4} \
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins toplevel_0/m_axi_ocm]
  ...
  connect_bd_net -net toplevel_0_interrupt [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins toplevel_0/interrupt]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces toplevel_0/Data_m_axi_ocm] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_processing_system7_0_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x00040000 -offset 0xFFFC0000 [get_bd_addr_spaces toplevel_0/Data_m_axi_ocm] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_HIGH_OCM] SEG_processing_system7_0_ACP_HIGH_OCM
  create_bd_addr_seg -range 0x01000000 -offset 0xFC000000 [get_bd_addr_spaces toplevel_0/Data_m_axi_ocm] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_processing_system7_0_ACP_QSPI_LINEAR

  # Exclude Address Segments
  create_bd_addr_seg -range 0x00400000 -offset 0xE0000000 [get_bd_addr_spaces toplevel_0/Data_m_axi_ocm] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_IOP] SEG_processing_system7_0_ACP_IOP
  exclude_bd_addr_seg [get_bd_addr_segs toplevel_0/Data_m_axi_ocm/SEG_processing_system7_0_ACP_IOP]

  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces toplevel_0/Data_m_axi_ocm] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_M_AXI_GP0] SEG_processing_system7_0_ACP_M_AXI_GP0
  exclude_bd_addr_seg [get_bd_addr_segs toplevel_0/Data_m_axi_ocm/SEG_processing_system7_0_ACP_M_AXI_GP0]
...
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 2 -y 700 -defaultsOSRD
preplace inst toplevel_0 -pg 1 -lvl 1 -y 90 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 1 -y 310 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 3 -y 430 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -y 400 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 2 2 NJ 190 NJ
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 0 4 -410 540 NJ 540 NJ 550 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 2 1 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 2 -20 560 500
preplace netloc axi_mem_intercon_M00_AXI 1 1 1 -30
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 0 3 -380 180 NJ 180 NJ
preplace netloc xlconstant_0_dout 1 1 1 -30
preplace netloc toplevel_0_interrupt 1 1 1 -20
preplace netloc processing_system7_0_FIXED_IO 1 2 2 NJ 210 NJ
preplace netloc S00_AXI_1 1 0 2 -400 20 -20
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 0 3 -400 550 N 550 510
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 -390 190 -40 260 520
levelinfo -pg 1 -430 -200 260 740 910 -top 10 -bot 790
",
}
